...
public class RedisController {
    ...
    public String setAndGet(String key,String value){
        //String类型数据操作
        ValueOperations<String, String> stringTemplate = template.opsForValue();
        //hash类型数据操作
        HashOperations<String, Object, Object> hashTemplate = template.opsForHash();
        //list类型
        ListOperations<String, String> listTemplate = template.opsForList();
        //set类型 zset类型
